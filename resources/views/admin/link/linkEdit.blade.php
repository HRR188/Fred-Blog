                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        ...
                        <form class="am-form am-form-horizontal" >
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name="name" placeholder="名称 / Name" value="{{$link->name}}">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" name="link_url" placeholder="加上http://" value="{{$link->url}}">
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                ...
                                                <div id="show"></div>
                                                <input type="hidden" value="{{asset($link->logo)}}" id="linklogo_input" name="linklogo_input">
...
//                                                    $('#linklogo').attr('width',150);
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <a type="button" class="am-btn am-btn-primary" href="javascript:;" onclick="postInfo({{$link->id}})">保存修改</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                success(response){
                    ...
                    if(response.code ==200){
                        let node = '<div class="am-modal am-modal-alert" tabindex="-1" id="my-success">'
                            ...
                            +'<li class="alert-success">修改友链成功</li>'
                            +'</div>'
                            +'</div>'
                            +'</div>';
                        $('#showInfo').html(node);
