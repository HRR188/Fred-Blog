...
INSERT INTO `categories` VALUES ('5', 'Vue.js', '1', '2017-11-01 18:24:11', '2018-02-22 22:54:18', '29', null);
...
-- Records of columns
-- ----------------------------
INSERT INTO `columns` VALUES ('2', 'php算法', '2018-02-22 22:06:15', '2018-02-22 22:06:15');
...
INSERT INTO `migrations` VALUES ('20', '2018_02_22_214444_create_columns_table', '9');
...
-- Records of posts
-- ----------------------------
INSERT INTO `posts` VALUES ('1', '29', null, '2017-11-01 18:24:28', '2018-02-23 00:30:32', 'javascript闭包详解', '<p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">算数级数：与末项平方同阶</span></strong></span></p><pre class=\"brush:cpp;toolbar:false\">T(n) = 1+2+…+n = n(n+1)/2 = O(n2)</pre><p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">幂方级数：比幂次高出一阶</span></strong></span></p><p style=\"white-space: normal;\"><br/></p><pre class=\"brush:cpp;toolbar:false\">T2(n) = 12 + 22 + 32 + … + n2 = n(n+1)(2n+1)/6 = O(n3)\r\nT3(n) = 13 + 23 + 33 + … + n3 = n2(n+1)2/4 = O(n4)\r\nT4(n) = 14 + 24 + 34 + … + n4 = n(n+1)(2n+1)(3n2 + 3n -1)/30 = O(n5)\r\n…</pre><p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">几何级数(a > 1):与末项同阶</span></strong></span></p><pre class=\"brush:cpp;toolbar:false\">Ta(n) = a0 + a1 + … + an = (an+1 -1)/(a - 1) = O(an)\r\n1 + 2 + 4 + … + 2n = 2n+1 - 1 = O(2n+1) = O(2n)</pre><p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">收敛级数</span></strong></span></p><pre class=\"brush:cpp;toolbar:false\">1/1/2 + 1/2/3 + 1/3/4 + … + 1/(n-1)/n = 1 - 1/n = O(1)\r\n1 + 1/22 + … + 1/n2 < 1 + 1/22 + … = π2/6 = O(1)\r\n1/3 + 1/7 + 1/8 + 1/15 + 1/24 + 1/26 + 1/31 + 1/35 + … = 1 = O(1)</pre><p style=\"white-space: normal;\"><span style=\"font-family: 宋体;\">可能未必收敛，但是长度有限</span></p><p style=\"white-space: normal;\"><span style=\"font-family: 宋体;\"><br/></span></p><p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">调和级数</span></strong></span></p><pre class=\"brush:cpp;toolbar:false\">h(n) = 1 + 1/2 + 1/3 + \r\n…\r\n + 1/n = O(log(n))</pre><p style=\"white-space: normal;\"><span style=\"font-size: 20px;\"><strong><span style=\"font-family: 宋体;\">对数级数 </span></strong></span></p><pre class=\"brush:cpp;toolbar:false\">log(1) + log(2) + log(3) + \r\n…\r\n + log(n) = log(n!) = O(nlog(n))</pre><p style=\"white-space: normal;\">                          </p><pre style=\"background-color: rgb(255, 255, 255); font-family: \"Fira Code\"; font-size: 11.3pt;\"><br/></pre>', 'http://b.com/assets_admin/img/pimage.png', '356', null, '2');
...
INSERT INTO `post_tags` VALUES ('118', '1', '3', null, null);
INSERT INTO `post_tags` VALUES ('117', '1', '1', null, null);
